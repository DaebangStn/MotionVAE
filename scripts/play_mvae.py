import mvae.environments  # this line is required to import custom environments
from mvae.common.misc_utils import EpisodeRunner
...
def test_vae_replay_full_motion(args):
    ...
    env.seed(RAND_SEED)
    env.reset(seed=RAND_SEED, options=None)
        ...
        while not runner.done:
            ...
            for i in range(env.frame_skip):
                ...
                if done.any():
                    ...
                    env.reset(indices=reset_indices)
